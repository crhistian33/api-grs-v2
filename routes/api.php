...
Route::delete('/v1/workers/destroy/{type_worker}', [WorkerV1::class, 'destroyForce']);
...
Route::get('/v1/customers/getbycompany/{company}', [CustomerV1::class, 'getByCompany']);
...
Route::get('/v1/units/getbycompany/{company}', [UnitV1::class, 'getByCompany']);
